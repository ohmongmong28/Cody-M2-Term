...
def main():
    ...
    print(f"   ├── brand_output.txt   (전체 텍스트)")
    print(f"   ├── brand_output.pdf   (PDF 보고서)")
    print(f"   ├── brand_result.json  (구조화 데이터)")
    print(f"   ├── color_palette.png  (컬러 팔레트)")
    print(f"   ├── logo_concept_1.png (로고 시안 1)")
    print(f"   └── logo_concept_2.png (로고 시안 2)")
    print("=" * 50)
